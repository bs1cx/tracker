...
import { FileText, Edit, CheckCircle2, XCircle, Calendar } from "lucide-react"
                ...
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="grid gap-6 py-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-700">
                      ...
                      <div>
                        <p className="text-sm text-slate-400">Su (ml)</p>
                        <p className="text-lg font-semibold text-slate-200">
                          {summary.total_water_ml.toLocaleString()}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-slate-400">Kalori</p>
                        <p className="text-lg font-semibold text-slate-200">
                          {summary.total_calories.toLocaleString()}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-slate-400">Egzersiz (dk)</p>
                        <p className="text-lg font-semibold text-slate-200">
                          {summary.total_exercise_minutes}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                <p className="text-sm text-slate-400">Egzersiz</p>
                <p className="text-xl font-bold text-slate-200">
